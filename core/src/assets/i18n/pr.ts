export const appPR = {
  ...
  'modals': {
    ...
    'giftcoin': {
      ...
      'info': 'Você ganha imediatamente 2 moedas CAI de presente para baixar conteúdo offline!',
      'title': 'Bem-vindo ao CAI!'
    },
    'login': {
      'email': 'E-mail',
      'errors': {
  ...
  'pages': {
    ...
    'register': {
      ...
      'modalexit': {
        'cancel': 'Cancelar',
        'confirm': 'Excluir',
        'text': 'Ao finalizar a ação, a rota será excluída do seu perfil e do CAI. A operação não pode ser desfeita.',
    ...
    'registeruser': {
      ...
      'title': 'Junte-se à comunidade CAI!'
    },
    'route': {
      'btnFullMapExpand': 'Expandir',
      'btnFullMapReduce': 'Reduzir',
  ...
  'services': {
    ...
    'share': {
      ...
      'text': 'Aqui está uma rota interessante do CAI',
  ...
  'privacy': {
    'agree': {
      ...
      'message': 'Consinto que os meus dados sejam publicados',
      'read_privacy': 'Ler informações sobre o processamento de dados',
      'accept': 'Aceitar',
      'reject': 'Rejeitar',
      'confirm': {
        'title': 'Confirmar alteração',
        'accept_message': 'Tem certeza de que deseja aceitar o processamento de dados?',
        'reject_message': 'Tem certeza de que deseja rejeitar o processamento de dados?',
        'yes': 'Sim, confirmar',
        'no': 'Cancelar'
      },
      'final_confirm': {
        'title': 'Alteração concluída',
        'accept_message': 'O consentimento para o processamento de dados foi aceito com sucesso.',
        'reject_message': 'O consentimento para o processamento de dados foi rejeitado com sucesso.',
        'ok': 'OK'
      }
    }
  }
