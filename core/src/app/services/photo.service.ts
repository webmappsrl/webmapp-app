...
export class PhotoService {
  ...
  async shotPhoto(allowlibrary): Promise<PhotoItem> {
    const photo = await Camera.getPhoto({
      ...
      // source: allowlibrary ? CameraSource.Prompt : CameraSource.Camera,	//CameraSource	The source to get the photo from.By default this prompts the user to select either the photo album or take a photo.Default: CameraSource.Prompt
      ...
      webUseInput: true,	//boolean	Web only: Whether to use the PWA Element experience or file input.The default is to use PWA Elements if installed and fall back to file input.To always use file input, set this to true.Learn more about PWA Elements: https://capacitorjs.com/docs/pwa-elements
